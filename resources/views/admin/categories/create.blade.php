...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>اضافة الأقسام </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title"> الأقسام
        <small>اضافة الأقسام     </small>
    </h1>
@endsection
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control" value="{{old('name')}}" placeholder="اكتب أسم القسم">
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="details" id="description"></textarea>
