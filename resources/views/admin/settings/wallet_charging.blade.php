                                ...
                                <td>
                                    @if($wallet->payment_photo != null)
                                        <a type="button"  data-toggle="modal"
                                           data-target="#exampleModalScrollable{{$wallet->id}}">
                                            <img class="imageresource" src="{{asset('/uploads/payment_photos/'.$wallet->payment_photo)}}" height="50" width="50">
                                        </a>
                                        <div class="modal fade" id="exampleModalScrollable{{$wallet->id}}" tabindex="-1"
                                             role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalScrollableTitle">صورة التحويل البنكي للعميل لشحن المحفظه</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <img src="{{asset('/uploads/payment_photos/'.$wallet->payment_photo)}}"
                                                             width="500px"/>
                                                    </div>
