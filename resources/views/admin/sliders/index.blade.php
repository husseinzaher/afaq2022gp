...
@section('page_header')
    ...
    <h1 class="page-title">عرض السلايدر
        <small>عرض جميع السلايدر</small>
    </h1>
@endsection
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="{{url('/admin/sliders/create')}}"> إضافة جديد
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a class="delete_user" data="{{ $slider->id }}" data_name="{{ $slider->photo }}" >
