...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/users/user">المستخدمين</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                            ...
                            <div class="portlet-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <form role="form" action="/admin/update/user/{{$user->id}}/user" method="post" enctype="multipart/form-data">
                                            <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
                                            <div class="form-group">
                                                <label class="control-label">الاسم  الأول</label>
                                                <input type="text" name="firstName" placeholder="أكتب الأسم  الاول للعميل" class="form-control" value="{{$user->firstName}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="lastName" placeholder="أكتب الأسم  الأخير للعميل" class="form-control" value="{{$user->lastName}}" />
                                            ...
                                            {{--<div class="form-group">--}}
                                                ...
                                                {{--<input type="email" name="email" placeholder=" البريد الاكتروني" class="form-control" value="{{$user->email}}" />--}}
                                                {{--@if ($errors->has('email'))--}}
                                                    {{--<span class="help-block">--}}
                                                    ...
                                                    <td>
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="active" value="true" {{ $user->active == "true" ? 'checked' : '' }}/> نعم
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="active" value="false" {{$user->active == "false" ? 'checked' : '' }}/> لا
                                                                <span></span>
                                                            </label>
