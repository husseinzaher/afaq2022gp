...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/users/user')}}">المستخدمين</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            ...
                            <form role="form" action="{{url('/admin/add/user/user')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="firstName" placeholder="أكتب الأسم  الاول للعميل" class="form-control" value="{{old('firstName')}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="lastName" placeholder="أكتب الأسم  الأخير للعميل" class="form-control" value="{{old('lastName')}}" />
                                                    ...
                                                    <td>
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="active" value="true" {{ old('active') == "true" ? 'checked' : '' }}/> نعم
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="active" value="false" {{ old('active') == "false" ? 'checked' : '' }}/> لا
                                                                <span></span>
                                                            </label>
